...
class FileBackedTaskManagerTest {
    ...
    public void subtasksWithTheSameIdMustBeEqual() {
        Epic epic = new Epic("Эпик", "Завести эпик");
        Subtask subtask = new Subtask("Подзадача1", "Для эпика 1", epic.getId());
        Subtask subtask1 = new Subtask("Подзадача2", "Для эпика 1", epic.getId());
    ...
    void clearEpics() {
        ...
        Subtask subtask = new Subtask("Подзадача1", "Для эпика 1", epic1.getId());
        taskManager.createSubtasks(subtask);
    ...
    void clearSubtasks() {
        ...
        taskManager.createEpic(epic1);
        Subtask subtask = new Subtask("Подзадача1", "Для эпика 1", epic1.getId());
        Subtask subtask1 = new Subtask("Подзадача2", "Для эпика 1", epic1.getId());
        taskManager.createSubtasks(subtask);
